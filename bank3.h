...
// Scrolling functions for Stage 3 (replicated in each bank)
static void bank3_drawMetatileBlock(void)
{
...
static void bank3_draw_screen_L(void)
{
...
static void bank3_draw_screen_R(void)
{
...
static void bank3_new_cmap(void)
{
	offset = room_to_load;
	map = room_to_load & 1;
	if (!map) 
...
static void bank3_prep_scroll_screen(void)
{
...
static void bank3_handle_scrolling(void)
{
...
// Stage 3 specific functions
void bank3_load_room(void)
{

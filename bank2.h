...
// Scrolling functions for Stage 2 (replicated in each bank)
static void bank2_drawMetatileBlock(void)
{
...
static void bank2_draw_screen_L(void)
{
...
static void bank2_draw_screen_R(void)
{
...
static void bank2_new_cmap(void)
{
	offset = room_to_load;
	map = room_to_load & 1;
	if (!map) 
...
static void bank2_prep_scroll_screen(void)
{
...
static void bank2_handle_scrolling(void)
{
